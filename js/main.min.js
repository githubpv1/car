...
$('.report__slider').slick({
	...
	(function () {
		...
		$allBtn.filter('.active').next().slideDown(0, resizeLenis);
		...
		$allBtn.click(function () {
			...
			if ($attr === 'toggle') {
				...
				$btn.next().not($(this).next()).slideUp(500, resizeLenis);

				$(this).toggleClass('active').next().slideToggle(500, resizeLenis);
				...
				$btn.not($(this)).removeClass('active').attr('aria-expanded', false);
				$btn.next().not($(this).next()).slideUp(500, resizeLenis);
				$(this).addClass('active').attr('aria-expanded', true).next().slideDown(500, resizeLenis);
